import { EventEngine$1_$reflection, EventEngine$1 } from "../Feliz.Engine.Event.1.0.0-beta-004/EventEngine.fs.js";
import { nothing, removeClass, addClass, toggleClass, setClass, styleAppend, style, attr, html as html_1, fragment, text, el, onUnmount, onMount, on } from "./CoreElements.fs.js";
import { empty } from "../fable-library-js.4.21.0/List.js";
import { SutilEffect, ContextHelpers_withParent, buildChildren, SutilElement_Define_Z60F5000F, SutilElement_$reflection } from "./Core.fs.js";
import { class_type } from "../fable-library-js.4.21.0/Reflection.js";
import { int32ToString, defaultOf } from "../fable-library-js.4.21.0/Util.js";
import { FSharpRef } from "../fable-library-js.4.21.0/Types.js";
import { HtmlEngine$1__div_Z721C83C5, HtmlEngine$1__h6_Z721C83C5, HtmlEngine$1__h5_Z721C83C5, HtmlEngine$1__h4_Z721C83C5, HtmlEngine$1__h3_Z721C83C5, HtmlEngine$1__h2_Z721C83C5, HtmlEngine$1__h1_Z721C83C5, HtmlEngine$1__span_Z721C83C5, HtmlEngine$1__td_Z721C83C5, HtmlEngine$1__ol_BB573A, HtmlEngine$1__tbody_BB573A, HtmlEngine$1__hr_BB573A, HtmlEngine$1__a_BB573A, HtmlEngine$1__h6_BB573A, HtmlEngine$1__h5_BB573A, HtmlEngine$1__h4_BB573A, HtmlEngine$1__h3_BB573A, HtmlEngine$1__h2_BB573A, HtmlEngine$1__h1_BB573A, HtmlEngine$1__p_BB573A, HtmlEngine$1__dd_BB573A, HtmlEngine$1__dt_BB573A, HtmlEngine$1__dl_BB573A, HtmlEngine$1__li_BB573A, HtmlEngine$1__ul_BB573A, HtmlEngine$1__aside_BB573A, HtmlEngine$1__article_BB573A, HtmlEngine$1__footer_BB573A, HtmlEngine$1__header_BB573A, HtmlEngine$1__nav_BB573A, HtmlEngine$1__section_BB573A, HtmlEngine$1__label_BB573A, HtmlEngine$1__input_BB573A, HtmlEngine$1__td_BB573A, HtmlEngine$1__tr_BB573A, HtmlEngine$1__thead_BB573A, HtmlEngine$1__table_BB573A, HtmlEngine$1__i_BB573A, HtmlEngine$1__img_BB573A, HtmlEngine$1__span_BB573A, HtmlEngine$1__button_BB573A, HtmlEngine$1__div_BB573A, HtmlEngine$1_$reflection, HtmlEngine$1 } from "../Feliz.Engine.1.0.0-beta-004/HtmlEngine.fs.js";
import { Bind_style_14B41C44, Bind_el_ZF0512D0 } from "./Bind.fs.js";
import { StoreOperators_op_DotGreater, Store_distinct } from "./Store.fs.js";
import { singleton, append, delay, toList } from "../fable-library-js.4.21.0/Seq.js";
import { AttrEngine$1_$reflection, AttrEngine$1 } from "../Feliz.Engine.1.0.0-beta-004/AttrEngine.fs.js";
import { bindAttrBoth, bindAttrIn } from "./Bindings.fs.js";
import { CssEngine$1_$ctor_Z19E9258B } from "../Feliz.Engine.1.0.0-beta-004/CssEngine.fs.js";
...
export function SutilEventEngine_$reflection() {
    return class_type("Sutil.SutilEventEngine", undefined, SutilEventEngine, EventEngine$1_$reflection(SutilElement_$reflection()));
}
...
export function SutilHtmlEngine_$reflection() {
    return class_type("Sutil.SutilHtmlEngine", undefined, SutilHtmlEngine, HtmlEngine$1_$reflection(SutilElement_$reflection()));
}
...
export function SutilHtmlEngine__td_Z686281E5(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(v), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__td_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__td_76B5483C(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(StoreOperators_op_DotGreater(v, int32ToString)), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__td_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__td_Z198ADE65(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(StoreOperators_op_DotGreater(v, (value) => value.toString())), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__td_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__span_Z686281E5(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(v), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__span_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__span_76B5483C(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(StoreOperators_op_DotGreater(v, int32ToString)), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__span_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__span_Z198ADE65(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(StoreOperators_op_DotGreater(v, (value) => value.toString())), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__span_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__h1_Z686281E5(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(v), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__h1_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__h1_76B5483C(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(StoreOperators_op_DotGreater(v, int32ToString)), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__h1_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__h1_Z198ADE65(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(StoreOperators_op_DotGreater(v, (value) => value.toString())), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__h1_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__h2_Z686281E5(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(v), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__h2_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__h2_76B5483C(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(StoreOperators_op_DotGreater(v, int32ToString)), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__h2_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__h2_Z198ADE65(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(StoreOperators_op_DotGreater(v, (value) => value.toString())), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__h2_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__h3_Z686281E5(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(v), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__h3_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__h3_76B5483C(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(StoreOperators_op_DotGreater(v, int32ToString)), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__h3_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__h3_Z198ADE65(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(StoreOperators_op_DotGreater(v, (value) => value.toString())), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__h3_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__h4_Z686281E5(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(v), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__h4_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__h4_76B5483C(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(StoreOperators_op_DotGreater(v, int32ToString)), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__h4_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__h4_Z198ADE65(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(StoreOperators_op_DotGreater(v, (value) => value.toString())), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__h4_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__h5_Z686281E5(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(v), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__h5_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__h5_76B5483C(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(StoreOperators_op_DotGreater(v, int32ToString)), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__h5_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__h5_Z198ADE65(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(StoreOperators_op_DotGreater(v, (value) => value.toString())), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__h5_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__h6_Z686281E5(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(v), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__h6_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__h6_76B5483C(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(StoreOperators_op_DotGreater(v, int32ToString)), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__h6_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__h6_Z198ADE65(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(StoreOperators_op_DotGreater(v, (value) => value.toString())), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__h6_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__div_Z686281E5(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(v), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__div_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__div_76B5483C(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(StoreOperators_op_DotGreater(v, int32ToString)), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__div_Z721C83C5(objectArg, v_1)));
}

export function SutilHtmlEngine__div_Z198ADE65(_, v) {
    let objectArg;
    return Bind_el_ZF0512D0(Store_distinct(StoreOperators_op_DotGreater(v, (value) => value.toString())), (objectArg = _.this.contents, (v_1) => HtmlEngine$1__div_Z721C83C5(objectArg, v_1)));
}
...
export function SutilHtmlEngine___clsch(this$, cls, ch) {
...
export function SutilAttrEngine_$reflection() {
    return class_type("Sutil.SutilAttrEngine", undefined, SutilAttrEngine, AttrEngine$1_$reflection(SutilElement_$reflection()));
}
