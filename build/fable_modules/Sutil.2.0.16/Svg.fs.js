import { fragment, text, attr, elns } from "./CoreElements.fs.js";
import { SvgEngine$1_$reflection, SvgEngine$1 } from "../Feliz.Engine.1.0.0-beta-004/SvgEngine.fs.js";
import { SutilElement_$reflection } from "./Core.fs.js";
...
export function SutilSvgEngine_$reflection() {
    return class_type("Sutil.SutilSvgEngine", undefined, SutilSvgEngine, SvgEngine$1_$reflection(SutilElement_$reflection()));
}
